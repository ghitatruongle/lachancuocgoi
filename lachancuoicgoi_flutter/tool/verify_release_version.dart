...
const String expectedVersionName = '1.6.0';
const int expectedVersionCode = 14;
const String expectedBuildVersion = '$expectedVersionName+$expectedVersionCode';

void main() {
  final checks = <String, RegExp>{
    'pubspec.yaml': RegExp(r'^version:\s*1\.6\.0\+14\s*$', multiLine: true),
    'README.md': RegExp(r'\*\*Version\*\*:\s*`?1\.6\.0\+14`?'),
    ...
    'fastlane/metadata/android/STORE_LISTING.md': RegExp(
      r'Release version:\s*1\.6\.0\+14',
    ),
    'fastlane/metadata/ios/STORE_LISTING.md': RegExp(
      r'Release version:\s*1\.6\.0\+14',
    ),
    'docs/RELEASE_NOTES_v1.6.0.md': RegExp(r'v1\.6\.0\+14'),
    'docs/RELEASE_CHECKLIST_v1.6.0.md': RegExp(r'v1\.6\.0\+14'),
    'tool/build_release.ps1': RegExp(r'v1\.6\.0\+14'),
  };
