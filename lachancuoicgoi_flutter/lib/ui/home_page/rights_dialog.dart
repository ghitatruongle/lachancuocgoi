                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      _PermissionItem(
                        ...
                        description:
                            'Đọc lịch sử cuộc gọi liên quan tới giám sát.',
                      ...
                      _PermissionItem(
                        ...
                        isInFlight: _inFlightPermissions.contains('overlay'),
                  ...
                  children: [
                    if (!state.allGranted)
                      ElevatedButton.icon(
                        ...
                        label: Text(
                          _isRequestingAll ? 'Đang cấp...' : 'Cấp tất cả',
                        ),
