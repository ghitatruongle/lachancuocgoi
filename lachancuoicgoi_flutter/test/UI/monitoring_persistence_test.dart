...
class ManualMockAnalysisCoordinator implements AnalysisCoordinator {
  @override
  Future<AnalysisResult> analyze(String text, AnalysisMode mode) async => const AnalysisResult(overallRiskLevel: RiskLevel.green, matches: [], analysisLevel: AnalysisLevel.l1);
  @override
  Future<AnalysisResult> analyzeIncremental(String fullText, AnalysisMode mode) async => const AnalysisResult(overallRiskLevel: RiskLevel.green, matches: [], analysisLevel: AnalysisLevel.l1);
  @override
  Future<AnalysisResult?> analyzeIncrementalL3(String fullText) async => null;
  @override
  Future<AnalysisResult> analyzeWithTranscript(String incrementalText, String fullText, AnalysisMode mode) async => const AnalysisResult(overallRiskLevel: RiskLevel.green, matches: [], analysisLevel: AnalysisLevel.l1);
  @override
  void closeL3Session({bool resetProgress = false}) {}
  @override
  void createL3Session({int initialProcessedTextLength = 0}) {}
  @override
  AnalysisResult getLastResult([AnalysisMode? mode]) => const AnalysisResult(overallRiskLevel: RiskLevel.green, matches: [], analysisLevel: AnalysisLevel.l1);
  @override
...
class ManualMockNativeBridge implements NativeBridgeInterface {
  ...
  @override
  Stream<(MonitoringState, int?, String?)> get monitoringStateStream => const Stream.empty();
  @override
...
void main() {
  ...
  test('MonitoringController Persistence - saves analysisResult and alertHistory', () async {
    ...
    const result = AnalysisResult(
      ...
      matches: [KeywordMatch(keyword: 'OTP', level: RiskLevel.red, category: 'Test')],
    ...
    final savedResult = AnalysisResult.fromJson(jsonDecode(captured.analysisResult!) as Map<String, dynamic>);
