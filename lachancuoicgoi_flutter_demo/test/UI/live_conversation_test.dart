...
void main() {
  ...
  group('LiveConversation', () {
    testWidgets(
      'shows listening placeholder when transcript empty and not simulation',
      (tester) async {
        await tester.pumpWidget(
          wrap(const LiveConversation(transcript: '', isSimulation: false)),
        );
    ...
    testWidgets(
      'shows simulation waiting when transcript empty and simulation',
      (tester) async {
        await tester.pumpWidget(
          wrap(const LiveConversation(transcript: '', isSimulation: true)),
        );
    ...
    testWidgets('updates when transcript changes', (tester) async {
      await tester.pumpWidget(
        wrap(const LiveConversation(transcript: 'First', isSimulation: false)),
      );

      expect(find.text('First'), findsOneWidget);

      await tester.pumpWidget(
        wrap(const LiveConversation(transcript: 'Second', isSimulation: false)),
      );
