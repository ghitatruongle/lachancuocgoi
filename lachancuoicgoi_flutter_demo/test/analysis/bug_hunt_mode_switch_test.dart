  ...
  group('BUG-HUNT-MODE — switching AnalysisMode mid-call', () {
    test(
      ...
      () async {
        ...
        final l1Length = coordinator.getProcessedTextLength(AnalysisMode.normal);
        expect(l1Length, 200);
    ...
    test(
      'BUG-MODE-2: parallel mode respects 800ms L3 timeout',
      () async {
        final coordinator = AnalysisCoordinator(
    ...
    test(
      'BUG-MODE-3: effective mode = selected mode when network ok',
      () {
    ...
    test(
      'BUG-MODE-4: parallel fallback to L2/L1 when L3 not ready',
      () async {
        final coordinator = AnalysisCoordinator(
    ...
    test(
      ...
      () async {
        ...
        final after = coordinator.getProcessedTextLength(
          AnalysisMode.parallel,
        );
        expect(after, 0,
