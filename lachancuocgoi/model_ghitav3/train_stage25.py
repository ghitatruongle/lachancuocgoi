...
print("="*80)
print("🎭 STAGE 25: DEEPFAKE & EMERGENCY CONTEXTS 🎭")
print("TARGET: LEARN DEEPFAKE CUES & URGENCY (LABEL 4, 7)")
print("="*80)

DATA_PATH = "stage25_scenarios_deepfake_context.csv"
REPLAY_PATH = "stage23_master_replay.csv"
MODEL_LOAD_PATH = "checkpoint_stage24_Final"
MODEL_SAVE_PATH = "checkpoint_stage25_Final"
...
if 7 in cw_dict: cw_dict[7] = cw_dict[7] * 2.5
if 4 in cw_dict: cw_dict[4] = cw_dict[4] * 2.5
