...
print("="*80)
print("🦠 STAGE 26: CROSS-PLATFORM MALWARE & PHISHING 🦠")
print("TARGET: LEARN APP INSTALLATION TRICKS & LINK PHISHING (LABEL 1, 3)")
print("="*80)

DATA_PATH = "stage26_scenarios_cross_platform_malware.csv"
REPLAY_PATH = "stage23_master_replay.csv"
MODEL_LOAD_PATH = "checkpoint_stage25_Final"
MODEL_SAVE_PATH = "checkpoint_stage26_Final"
...
if 1 in cw_dict: cw_dict[1] = cw_dict[1] * 2.5
if 3 in cw_dict: cw_dict[3] = cw_dict[3] * 2.5
